        ...
        <label className="modal-box flex flex-col gap-4 pt-2">
          <div className="flex w-full gap-2">
            <div className="tabs flex-grow">
              <a className="tab tab-bordered tab-active flex-grow">Username</a>
            </div>
            {session?.user !== null && (
          ...
          <form className="flex flex-col" onSubmit={updateGuestName}>
            <div className="form-control">
              ...
              <label className="input-group">
                ...
                <input
                  ...
                  maxLength={16}
                  minLength={2}
                  disabled={session?.account ? false : true}
                  // required
                />
              </label>
            </div>
            <div className="modal-action">
              ...
              <button className="btn shadow-border z-[100]" onClick={session?.connectWallet}>
                Connect
              </button>
            </div>
          </form>
